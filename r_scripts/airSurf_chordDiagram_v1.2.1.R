...
df <- abri_kraken2_filtered %>%
  filter(grepl("P. aeruginosa|E. faecium|S. aureus|A. baumannii|K. pneumoniae|K. quasipneumoniae|A. lwoffii|E. cloacae complex|E. hormaechei|E. coli|S. aureus|R. aquatilis", NAME))
